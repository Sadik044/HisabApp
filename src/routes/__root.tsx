...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Smart personal finance management using the proven 6 Jar Method. Free to use." },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "/og-image.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "HisabApp - 6 Jar Money Management" },
      { name: "twitter:description", content: "Auto-split income into 6 jars. Track expenses. Build financial discipline." },
